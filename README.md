...
- **Video Support**: Integrated with `yt-dlp` to support high-resolution video and audio from thousands of platforms.
...
- **Smart Categorization**: Automatically organizes downloads into Videos, Music, Archives, Software, and Documents based on file extensions.
